...
_LEGACY_GZIP_COMPRESSION_VALS = frozenset(list(range(10)))
...
class Dataset(HLObject):
    ...
    def __getitem__(self, args):
        ...
        * Boolean "mask" array indexing
        ...
        if not py3:
            names = tuple(x.encode('utf-8') if isinstance(x, str) else x for x in names)
